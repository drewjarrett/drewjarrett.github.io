    ...
    return (
      <div>
        ...
        <a-scene
          ...
          <a-entity gltf-model="./assets/magnemite/scene.gltf" rotation="0 180 0" scale="0.15 0.15 0.15" gps-entity-place="longitude: {this.state.lng}; latitude: {this.state.lat};" animation-mixer />
        </a-scene>
      </div>
    );
  }
